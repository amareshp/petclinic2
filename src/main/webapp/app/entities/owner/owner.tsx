...
export interface IOwnerState extends IPaginationBaseState {
  search: string;
}

export class Owner extends React.Component<IOwnerProps, IOwnerState> {
  state: IOwnerState = {
    search: '',
  ...
  render() {
    const { ownerList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="owner-heading">
          Owners
